...
class Pagina extends BaseController
{
    ...
    function lista_tarefas()
    {
        ...
        $array_view['titulo'] = "Lista de Corte";
        $array_view['array_titulo_lista'] = array("Prioridade", "Desenhista", "Nome do arquivo", "Empresa/Cliente", "Empreendimento", "Finalidade","Subpastas", "Data de Envio", "Cortar", "Confirmar Corte");
