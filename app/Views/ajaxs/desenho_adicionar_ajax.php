                    ...
                    for (let j = 0; j < desenhos.length; j++) {
                        ...
                        for (let h = 1; h < 4; h++) {
                            ...
                            if (document.getElementById("tag" + h + "_novo_" + j)) {
                                ...
                                let empreendimentoSelect = document.getElementById("empreendimento_novo_" + j);
                                let empreendimento = empreendimentoSelect.value;
