...
<div class="wrapper">
  ...
  <a href="" class="d-block capitalized"><i class="fa-solid fa-user" color="#fff"></i> <?php echo $nomeUsuario ?></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" id="botao_fechar_modal" onclick="closeModal()">Cancelar</button>
        <button type="button" class="btn btn-primary" id="botao_confirmar_modal"   onclick="closeModal()">Confirmar corte</button>
      </div>
    </div>
  </div>
</div>
