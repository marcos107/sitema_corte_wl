    ...
    <div class="wrapper">
      ...
      <li class="nav-item d-none d-sm-inline-block">
                            ...
                            <div class="card card-secondary">
                                ...
                                <div class="card-body" id="inputs_body">
                                    ...
                                    foreach ($array_input_typ as $kay => $value) {
                                        switch ($value) {
                                            case 'select':
                                                echo '<div class="form-group" id = "group_'.$id_group.'">
        ...
        <div id="meusScripts">
            ...
            <script
                src="<?php echo base_url(); ?>public/assets/style/plugins/datatables/jquery.dataTables.min.js"></script>
            <script
            ...
            <script>
                ...
                function mudar_button() {
                    ...
                    var elemento2 = document.getElementById("lista");
