...
class Adm extends BaseController
{
  ...
  function lista_corte()
  {
    ...
    $array_view = [
      ...
      'titulo_lista' => '',
      'functiontype_lista' => '',
      'ajax' => 'ajaxs/adm/lista_corte_ajax'
    ];
...
/**
  ...
  function desenhos_cortados()
  {
    ...
    $array_view = array(
      ...
      'titulo_lista' => '',
      'functiontype_lista' => '',
      'ajax' => 'ajaxs/adm/desenhos_cortados_ajax',
      'hora_lista' => true
    );
  ...
  function config_empresa_cliente()
  {
    ...
    $array_view = array(
      ...
      'titulo_lista' => '',
      'functiontype_lista' => '',
      'ajax' => 'ajaxs/adm/config_empresa_cliente_ajax'
    );
  ...
  function config_finalidade()
  {
    ...
    $array_view = array(
      ...
      'titulo_lista' => '',
      'functiontype_lista' => '',
      'ajax' => 'ajaxs/adm/config_finalidade_ajax'
    );
  ...
  function config_prioridade()
  {
    ...
    $array_view = array(
      ...
      'titulo_lista' => '',
      'functiontype_lista' => '',
      'ajax' => 'ajaxs/adm/config_prioridade_ajax'
    );
  ...
  function config_tipo_de_arquivo()
  {
    ...
    $array_view = array(
      ...
      'titulo_lista' => '',
      'functiontype_lista' => '',
      'ajax' => 'ajaxs/adm/config_tipo_de_arquivo_ajax'
    );
  ...
  function user_modificar()
  {
    ...
    $array_view = array(
      ...
      'titulo_lista' => '',
      'functiontype_lista' => '',
      'ajax' => 'ajaxs/adm/user_modificar_ajax'
    );
    // Título da página.
  ...
  function user_cadastrar()
  {
    ...
    $array_view = array(
      ...
      'titulo_lista' => '',
      'functiontype_lista' => '',
      'ajax' => 'ajaxs/adm/user_cadastrar_ajax'
    );
  ...
  function relatorios_analitico()
  {
    // Verifica se o usuário está autenticado como administrador.
    //Login::verifica_permissao("Relatorio analítico");
    Login::verifica_login('adm');
    ...
    $array_view = array(
      ...
      'titulo_lista' => '',
      'functionType_lista' => '',
      'ajax' => 'ajaxs/adm/relatorios_analitico_ajax.php'
