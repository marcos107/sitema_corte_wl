...
public function ver_desenho()
{
    ...
    $diretorioArquivo = Ferramentas::wlStoragePath((string) ($novaEntrada['diretorio'] ?? ''));
    $caminho     = dirname($diretorioArquivo) . DIRECTORY_SEPARATOR;
    $nomeArquivo = basename($diretorioArquivo);
    $nome_ajuste1 = "";
    $nome_ajuste2 = "";
    ...
    public function desenho_adicionar_projeto()
    {
        ...
        $diretorioFisico = rtrim($diretorioProjeto, DIRECTORY_SEPARATOR);
